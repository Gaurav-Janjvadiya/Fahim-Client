      ...
      <Element className="features">
        <div className="relative flex items-center p-4">
          ...
          <div className="w-full p-3 flex flex-col items-center justify-start">
            <div className="m-10">
              <h1 className="text-4xl sm:text-6xl font-extrabold text-white hover:bg-slate-900 mb-10 text-center">
                Why Choose Fahim?
              </h1>
            </div>
            <div className="flex flex-wrap items-center justify-center">
              {/* Card 1 */}
              <div className="text-white border rounded-lg w-full sm:w-[45%] md:w-[30%] lg:w-[20%] mx-4 p-6 h-[35vh] shadow-lg hover:scale-105 transition-all duration-300 mb-4 sm:mb-0 backdrop-blur-lg bg-opacity-20">
